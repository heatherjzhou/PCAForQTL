...
Lastly, we recommend saving the plot for each tissue type (using code similar to below) in order to **compare across all tissue types** before making a final decision on how to choose $K$.
